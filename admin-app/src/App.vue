    ...
    <template v-if="auth.isLoggedIn">
      ...
      <aside class="sidebar" :class="{ open: navOpen }">
        ...
        <nav class="sidebar-nav">
          <router-link to="/"         class="nav-item" active-class="active" exact       @click="navOpen = false"><span>📊</span> Dashboard</router-link>
          <router-link to="/orders"   class="nav-item" active-class="active"             @click="navOpen = false"><span>📋</span> Orders</router-link>
...
const titleMap = {
  ...
  '/members': 'Members', '/vouchers': 'Vouchers', '/counter': 'Walk-in Points',
}
