...
const routes = [
  ...
  { path: '/members/:id',      name: 'MemberHistory', component: () => import('@/views/MemberHistoryView.vue'), meta: { requiresAuth: true } },
  { path: '/members/:id/edit', name: 'MemberEdit',    component: () => import('@/views/MemberEditView.vue'),    meta: { requiresAuth: true } },
